...
public class SettingDBActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Surat surat98 = new Surat(98, "AL-BAYYINAH", 8, 90, 17);
        ...
        long surat98_id = db.createSurat(surat98);
        ...
        //099 - al-zalzalah
        Kata kata0990101 = new Kata(356, 99, 1, 1, "990101", 1);
        Kata kata0990102 = new Kata(357, 99, 1, 2, "990102", 2);
        Kata kata0990103 = new Kata(358, 99, 1, 3, "990103", 3);
        Kata kata0990104 = new Kata(359, 99, 1, 4, "990104", 4);
        Kata kata0990201 = new Kata(360, 99, 2, 1, "990201", 5);
        Kata kata0990202 = new Kata(361, 99, 2, 2, "990202", 6);
        Kata kata0990203 = new Kata(362, 99, 2, 3, "990203", 7);
        Kata kata0990301 = new Kata(363, 99, 3, 1, "990301", 8);
        Kata kata0990302 = new Kata(364, 99, 3, 2, "990302", 9);
        Kata kata0990303 = new Kata(365, 99, 3, 3, "990303", 10);
        Kata kata0990304 = new Kata(366, 99, 3, 4, "990304", 11);
        Kata kata0990401 = new Kata(367, 99, 4, 1, "990401", 12);
        Kata kata0990402 = new Kata(368, 99, 4, 2, "990402", 13);
        Kata kata0990403 = new Kata(369, 99, 4, 3, "990403", 14);
        Kata kata0990501 = new Kata(370, 99, 5, 1, "990501", 15);
        Kata kata0990502 = new Kata(371, 99, 5, 2, "990502", 16);
        Kata kata0990503 = new Kata(372, 99, 5, 3, "990503", 17);
        Kata kata0990504 = new Kata(373, 99, 5, 4, "990504", 18);
        Kata kata0990601 = new Kata(374, 99, 6, 1, "990601", 19);
        Kata kata0990602 = new Kata(375, 99, 6, 2, "990602", 20);
        Kata kata0990603 = new Kata(376, 99, 6, 3, "990603", 21);
        Kata kata0990604 = new Kata(378, 99, 6, 4, "990604", 22);
        Kata kata0990605 = new Kata(379, 99, 6, 5, "990605", 23);
        Kata kata0990606 = new Kata(380, 99, 6, 6, "990606", 24);
        Kata kata0990701 = new Kata(381, 99, 7, 1, "990701", 25);
        Kata kata0990702 = new Kata(382, 99, 7, 2, "990702", 26);
        Kata kata0990703 = new Kata(383, 99, 7, 3, "990703", 27);
        Kata kata0990704 = new Kata(384, 99, 7, 4, "990704", 28);
        Kata kata0990705 = new Kata(385, 99, 7, 5, "990705", 29);
        Kata kata0990706 = new Kata(386, 99, 7, 6, "990706", 30);
        Kata kata0990801 = new Kata(387, 99, 8, 1, "990801", 31);
        Kata kata0990802 = new Kata(388, 99, 8, 2, "990802", 32);
        Kata kata0990803 = new Kata(389, 99, 8, 3, "990803", 33);
        Kata kata0990804 = new Kata(390, 99, 8, 4, "990804", 34);
        Kata kata0990805 = new Kata(391, 99, 8, 5, "990805", 35);
        Kata kata0990806 = new Kata(392, 99, 8, 6, "990806", 36);

        //098 - al-bayyinah
        Kata kata0980101 = new Kata(393, 98, 1, 1, "980101", 1);
        Kata kata0980102 = new Kata(394, 98, 1, 2, "980102", 2);
        Kata kata0980103 = new Kata(395, 98, 1, 3, "980102", 3);
        Kata kata0980104 = new Kata(396, 98, 1, 4, "980102", 4);
        Kata kata0980105 = new Kata(397, 98, 1, 5, "980102", 5);
        Kata kata0980106 = new Kata(398, 98, 1, 6, "980102", 6);
        Kata kata0980107 = new Kata(399, 98, 1, 7, "980102", 7);
        Kata kata0980108 = new Kata(400, 98, 1, 8, "980102", 8);
        Kata kata0980109 = new Kata(401, 98, 1, 9, "980102", 9);
        Kata kata0980201 = new Kata(402, 98, 2, 1, "980201", 10);
        Kata kata0980202 = new Kata(403, 98, 2, 2, "980202", 11);
        Kata kata0980203 = new Kata(404, 98, 2, 3, "980203", 12);
        Kata kata0980204 = new Kata(405, 98, 2, 4, "980204", 13);
        Kata kata0980205 = new Kata(406, 98, 2, 5, "980205", 14);
        Kata kata0980206 = new Kata(407, 98, 2, 6, "980206", 15);
        Kata kata0980301 = new Kata(408, 98, 3, 1, "980301", 16);
        Kata kata0980302 = new Kata(409, 98, 3, 2, "980302", 17);
        Kata kata0980303 = new Kata(410, 98, 3, 3, "980303", 18);
        Kata kata0980401 = new Kata(411, 98, 4, 1, "980401", 19);
        Kata kata0980402 = new Kata(412, 98, 4, 2, "980402", 20);
        Kata kata0980403 = new Kata(413, 98, 4, 3, "980403", 21);
        Kata kata0980404 = new Kata(414, 98, 4, 4, "980404", 22);
        Kata kata0980405 = new Kata(415, 98, 4, 5, "980405", 23);
        Kata kata0980406 = new Kata(416, 98, 4, 6, "980406", 24);
        Kata kata0980407 = new Kata(417, 98, 4, 7, "980407", 25);
        Kata kata0980408 = new Kata(418, 98, 4, 8, "980408", 26);
        Kata kata0980409 = new Kata(419, 98, 4, 9, "980409", 27);
        Kata kata09804010 = new Kata(420, 98, 4, 10, "9804010", 28);
        Kata kata09804011 = new Kata(421, 98, 4, 11, "9804011", 29);
        Kata kata0980501 = new Kata(422, 98, 5, 1, "980501", 30);
        Kata kata0980502 = new Kata(423, 98, 5, 2, "980502", 31);
        Kata kata0980503 = new Kata(424, 98, 5, 3, "980503", 32);
        Kata kata0980504 = new Kata(425, 98, 5, 4, "980504", 33);
        Kata kata0980505 = new Kata(426, 98, 5, 5, "980505", 34);
        Kata kata0980506 = new Kata(427, 98, 5, 6, "980506", 35);
        Kata kata0980507 = new Kata(428, 98, 5, 7, "980507", 36);
        Kata kata0980508 = new Kata(429, 98, 5, 8, "980508", 37);
        Kata kata0980509 = new Kata(430, 98, 5, 9, "980509", 38);
        Kata kata09805010 = new Kata(431, 98, 5, 10, "9805010", 39);
        Kata kata09805011 = new Kata(432, 98, 5, 11, "9805011", 40);
        Kata kata09805012 = new Kata(433, 98, 5, 12, "9805012", 41);
        Kata kata09805013 = new Kata(434, 98, 5, 13, "9805013", 42);
        Kata kata09805014 = new Kata(435, 98, 5, 14, "9805014", 43);
        Kata kata09805015 = new Kata(436, 98, 5, 15, "9805015", 44);
        Kata kata0980601 = new Kata(437, 98, 6, 1, "980601", 45);
        Kata kata0980602 = new Kata(438, 98, 6, 2, "980602", 46);
        Kata kata0980603 = new Kata(439, 98, 6, 3, "980603", 47);
        Kata kata0980604 = new Kata(440, 98, 6, 4, "980604", 48);
        Kata kata0980605 = new Kata(441, 98, 6, 5, "980604", 49);
        Kata kata0980606 = new Kata(442, 98, 6, 6, "980604", 50);
        Kata kata0980607 = new Kata(443, 98, 6, 7, "980604", 51);
        Kata kata0980608 = new Kata(444, 98, 6, 8, "980604", 52);
        Kata kata0980609 = new Kata(445, 98, 6, 9, "980604", 53);
        Kata kata09806010 = new Kata(446, 98, 6, 10, "9806010", 54);
        Kata kata09806011 = new Kata(447, 98, 6, 11, "9806011", 55);
        Kata kata09806012 = new Kata(448, 98, 6, 12, "9806012", 56);
        Kata kata09806013 = new Kata(449, 98, 6, 13, "9806013", 57);
        Kata kata09806014 = new Kata(450, 98, 6, 14, "9806014", 58);
        Kata kata09806015 = new Kata(451, 98, 6, 15, "9806015", 59);
        Kata kata09806016 = new Kata(452, 98, 6, 16, "9806016", 60);
        Kata kata0980701 = new Kata(453, 98, 7, 1, "980701", 61);
        Kata kata0980702 = new Kata(454, 98, 7, 2, "980702", 62);
        Kata kata0980703 = new Kata(455, 98, 7, 3, "980703", 63);
        Kata kata0980704 = new Kata(456, 98, 7, 4, "980704", 64);
        Kata kata0980705 = new Kata(457, 98, 7, 5, "980705", 65);
        Kata kata0980706 = new Kata(458, 98, 7, 6, "980706", 66);
        Kata kata0980707 = new Kata(459, 98, 7, 7, "980707", 67);
        Kata kata0980708 = new Kata(460, 98, 7, 8, "980708", 68);
        Kata kata0980709 = new Kata(461, 98, 7, 9, "980709", 69);
        Kata kata0980801 = new Kata(462, 98, 8, 1, "980801", 70);
        Kata kata0980802 = new Kata(463, 98, 8, 2, "980802", 71);
        Kata kata0980803 = new Kata(464, 98, 8, 3, "980803", 72);
        Kata kata0980804 = new Kata(465, 98, 8, 4, "980804", 73);
        Kata kata0980805 = new Kata(466, 98, 8, 5, "980805", 74);
        Kata kata0980806 = new Kata(467, 98, 8, 6, "980806", 75);
        Kata kata0980807 = new Kata(468, 98, 8, 7, "980807", 76);
        Kata kata0980808 = new Kata(469, 98, 8, 8, "980808", 77);
        Kata kata0980809 = new Kata(470, 98, 8, 9, "980809", 78);
        Kata kata09808010 = new Kata(471, 98, 8, 10, "9808010", 79);
        Kata kata09808011 = new Kata(472, 98, 8, 11, "9808011", 80);
        Kata kata09808012 = new Kata(473, 98, 8, 12, "9808012", 81);
        Kata kata09808013 = new Kata(474, 98, 8, 13, "9808013", 82);
        Kata kata09808014 = new Kata(475, 98, 8, 14, "9808014", 83);
        Kata kata09808015 = new Kata(476, 98, 8, 15, "9808015", 84);
        Kata kata09808016 = new Kata(477, 98, 8, 16, "9808016", 85);
        Kata kata09808017 = new Kata(478, 98, 8, 17, "9808017", 86);
        Kata kata09808018 = new Kata(479, 98, 8, 18, "9808018", 87);
        Kata kata09808019 = new Kata(480, 98, 8, 19, "9808019", 88);
        Kata kata09808020 = new Kata(481, 98, 8, 20, "9808020", 89);
        Kata kata09808021 = new Kata(482, 98, 8, 21, "9808021", 90);
        ...
        // 98
        long kata0980101_id = db.createKata(kata0980101);
        long kata0980102_id = db.createKata(kata0980102);
        long kata0980103_id = db.createKata(kata0980103);
        long kata0980104_id = db.createKata(kata0980104);
        long kata0980105_id = db.createKata(kata0980105);
        long kata0980106_id = db.createKata(kata0980106);
        long kata0980107_id = db.createKata(kata0980107);
        long kata0980108_id = db.createKata(kata0980108);
        long kata0980109_id = db.createKata(kata0980109);
        long kata0980201_id = db.createKata(kata0980201);
        long kata0980202_id = db.createKata(kata0980202);
        long kata0980203_id = db.createKata(kata0980203);
        long kata0980204_id = db.createKata(kata0980204);
        long kata0980205_id = db.createKata(kata0980205);
        long kata0980206_id = db.createKata(kata0980206);
        long kata0980301_id = db.createKata(kata0980301);
        long kata0980302_id = db.createKata(kata0980302);
        long kata0980303_id = db.createKata(kata0980303);
        long kata0980401_id = db.createKata(kata0980401);
        long kata0980402_id = db.createKata(kata0980402);
        long kata0980403_id = db.createKata(kata0980403);
        long kata0980404_id = db.createKata(kata0980404);
        long kata0980405_id = db.createKata(kata0980405);
        long kata0980406_id = db.createKata(kata0980406);
        long kata0980407_id = db.createKata(kata0980407);
        long kata0980408_id = db.createKata(kata0980408);
        long kata0980409_id = db.createKata(kata0980409);
        long kata09804010_id = db.createKata(kata09804010);
        long kata09804011_id = db.createKata(kata09804011);
        long kata0980501_id = db.createKata(kata0980501);
        long kata0980502_id = db.createKata(kata0980502);
        long kata0980503_id = db.createKata(kata0980503);
        long kata0980504_id = db.createKata(kata0980504);
        long kata0980505_id = db.createKata(kata0980505);
        long kata0980506_id = db.createKata(kata0980506);
        long kata0980507_id = db.createKata(kata0980507);
        long kata0980508_id = db.createKata(kata0980508);
        long kata0980509_id = db.createKata(kata0980509);
        long kata09805010_id = db.createKata(kata09805010);
        long kata09805011_id = db.createKata(kata09805011);
        long kata09805012_id = db.createKata(kata09805012);
        long kata09805013_id = db.createKata(kata09805013);
        long kata09805014_id = db.createKata(kata09805014);
        long kata09805015_id = db.createKata(kata09805015);
        long kata0980601_id = db.createKata(kata0980601);
        long kata0980602_id = db.createKata(kata0980602);
        long kata0980603_id = db.createKata(kata0980603);
        long kata0980604_id = db.createKata(kata0980604);
        long kata0980605_id = db.createKata(kata0980605);
        long kata0980606_id = db.createKata(kata0980606);
        long kata0980607_id = db.createKata(kata0980607);
        long kata0980608_id = db.createKata(kata0980608);
        long kata0980609_id = db.createKata(kata0980609);
        long kata09806010_id = db.createKata(kata09806010);
        long kata09806011_id = db.createKata(kata09806011);
        long kata09806012_id = db.createKata(kata09806012);
        long kata09806013_id = db.createKata(kata09806013);
        long kata09806014_id = db.createKata(kata09806014);
        long kata09806015_id = db.createKata(kata09806015);
        long kata09806016_id = db.createKata(kata09806016);
        long kata0980701_id = db.createKata(kata0980701);
        long kata0980702_id = db.createKata(kata0980702);
        long kata0980703_id = db.createKata(kata0980703);
        long kata0980704_id = db.createKata(kata0980704);
        long kata0980705_id = db.createKata(kata0980705);
        long kata0980706_id = db.createKata(kata0980706);
        long kata0980707_id = db.createKata(kata0980707);
        long kata0980708_id = db.createKata(kata0980708);
        long kata0980709_id = db.createKata(kata0980709);
        long kata0980801_id = db.createKata(kata0980801);
        long kata0980802_id = db.createKata(kata0980802);
        long kata0980803_id = db.createKata(kata0980803);
        long kata0980804_id = db.createKata(kata0980804);
        long kata0980805_id = db.createKata(kata0980805);
        long kata0980806_id = db.createKata(kata0980806);
        long kata0980807_id = db.createKata(kata0980807);
        long kata0980808_id = db.createKata(kata0980808);
        long kata0980809_id = db.createKata(kata0980809);
        long kata09808010_id = db.createKata(kata09808010);
        long kata09808011_id = db.createKata(kata09808011);
        long kata09808012_id = db.createKata(kata09808012);
        long kata09808013_id = db.createKata(kata09808013);
        long kata09808014_id = db.createKata(kata09808014);
        long kata09808015_id = db.createKata(kata09808015);
        long kata09808016_id = db.createKata(kata09808016);
        long kata09808017_id = db.createKata(kata09808017);
        long kata09808018_id = db.createKata(kata09808018);
        long kata09808019_id = db.createKata(kata09808019);
        long kata09808020_id = db.createKata(kata09808020);
        long kata09808021_id = db.createKata(kata09808021);
        ...
        BlokKosong blokkosong1008 = new BlokKosong(45, 100, 2, 13);
        BlokKosong blokkosong1007 = new BlokKosong(46, 99, 1, 5);
        BlokKosong blokkosong1006 = new BlokKosong(47, 99, 2, 10);
        BlokKosong blokkosong1005 = new BlokKosong(48, 99, 3, 15);
        BlokKosong blokkosong1004 = new BlokKosong(49, 98, 1, 5);
        BlokKosong blokkosong1003 = new BlokKosong(50, 98, 2, 10);
        BlokKosong blokkosong1002 = new BlokKosong(51, 98, 3, 15);
        ...
        long blokkosong1007_id = db.createBlokKosong(blokkosong1007);
        long blokkosong1006_id = db.createBlokKosong(blokkosong1006);
        long blokkosong1005_id = db.createBlokKosong(blokkosong1005);
        long blokkosong1004_id = db.createBlokKosong(blokkosong1004);
        long blokkosong1003_id = db.createBlokKosong(blokkosong1003);
        long blokkosong1002_id = db.createBlokKosong(blokkosong1002);
